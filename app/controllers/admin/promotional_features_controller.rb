class Admin::PromotionalFeaturesController < Admin::BaseController
  ...
  def promotional_feature_params
    params.require(:promotional_feature)
          .permit(:title, promotional_feature_items_attributes: [
                            :summary, :image, :image_alt_text, :title,
                            :title_url, :double_width, :image_cache,
