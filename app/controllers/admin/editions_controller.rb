class Admin::EditionsController < Admin::BaseController
  ...
  def edition_params
    params.fetch(:edition, {})
          .permit(:title, :body, :change_note, :summary, :first_published_at,
                  ...
                  :roll_call_introduction, :operational_field_id,
                  :news_article_type_id, :relevant_to_local_government,
                  :role_appointment_id, :speech_type_id, :delivered_on,
                  :location, :person_override, :locale,
                  :primary_mainstream_category_id,
                  ...
                  user_needs_attributes: [
                    :user, :need, :goal, :organisation_id],
                  fatality_notice_casualties_attributes: [
                    :personal_details, :_destroy])
